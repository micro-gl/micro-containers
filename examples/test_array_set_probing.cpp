...
#include <micro-containers/array_set_probing.h>

using namespace microc;

template<class Container>
void print_array_set_probing(const Container & container) {
    container.print(0);
}
...
void test_emplace() {
    ...
    using set = array_set_probing<int>;
    set d;
...
void test_insert_with_range() {
    ...
    print_array_set_probing(d_1);
    std::cout << "- printing set d2" << std::endl;
    print_array_set_probing(d_2);
...
void test_erase_with_key() {
    ...
    using dict = array_set_probing<int>;
    dict d;
...
//    d1.max_load_factor(3.0f);
//    d1.rehash(2);
//    print_array_set_probing_info(d1);
}
